...
mixin _$SignInState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(String userName, String userId) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(String userName, String userId)? success,
...
class _$SignInSuccessState implements SignInSuccessState {
  const _$SignInSuccessState(this.userName, this.userId);
  ...
  @override
  String toString() {
    return 'SignInState.success(userName: $userName, userId: $userId)';
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return success?.call(userName, userId);
  }
...
abstract class SignInSuccessState implements SignInState {
  const factory SignInSuccessState(final String userName, final String userId) =
